...
Continue **M1-01/M1-04** with durable callback and recovery evidence across real settlement owners and cross-driver store failures. Keep the SQL batch lost-update race, partial batch fan-out, atomic chain advance, Redis claim/enqueue crash window, Core NATS ephemerality, SQS visibility extension, and RabbitMQ reconnect/context-aware lifecycle gaps explicit.
