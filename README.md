...
<!-- test-count:embed:start -->
    <img src="https://img.shields.io/badge/tests-267-brightgreen" alt="Tests">
...
| **Observability** | [queue.Active](#queue-active) [queue.Archived](#queue-archived) [queue.Failed](#queue-failed) [queue.MultiObserver](#queue-multiobserver) [queue.Observe](#queue-observe) [queue.PauseQueue](#queue-pausequeue) [queue.Paused](#queue-paused) [queue.Pending](#queue-pending) [queue.Processed](#queue-processed) [queue.Queue](#queue-queue) [queue.Queues](#queue-queues) [queue.ResumeQueue](#queue-resumequeue) [queue.Scheduled](#queue-scheduled) [queue.Snapshot](#queue-snapshot) [queue.SnapshotQueue](#queue-snapshotqueue) [queue.SupportsNativeStats](#queue-supportsnativestats) [queue.SupportsPause](#queue-supportspause) [queue.Throughput](#queue-throughput) |
