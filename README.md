...
<!-- test-count:embed:start -->
    <img src="https://img.shields.io/badge/tests-78-brightgreen" alt="Tests">
...
| Group | Functions |
|------:|:-----------|
| **Constructors** | [NewDatabaseDispatcher](#newdatabasedispatcher) [NewDatabaseWorker](#newdatabaseworker) [NewDispatcher](#newdispatcher) [NewRedisDispatcher](#newredisdispatcher) [NewRedisWorker](#newredisworker) [NewSyncDispatcher](#newsyncdispatcher) [NewSyncWorker](#newsyncworker) [NewWorkerpoolDispatcher](#newworkerpooldispatcher) [NewWorkerpoolWorker](#newworkerpoolworker) |
...
### <a id="newdatabaseworker"></a>NewDatabaseWorker
...
### <a id="newredisworker"></a>NewRedisWorker
...
### <a id="newsyncworker"></a>NewSyncWorker
...
### <a id="newworkerpoolworker"></a>NewWorkerpoolWorker
