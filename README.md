...
| Group | Functions |
|------:|:-----------|
| **Batching** | [bus.Batch](#bus-batch) |
| **Chaining** | [bus.Chain](#bus-chain) |
| **Constructors** | [bus.New](#bus-new) [bus.NewFake](#bus-newfake) [bus.NewJob](#bus-newjob) [bus.NewWithStore](#bus-newwithstore) |
