...
| Group | Functions |
|------:|:-----------|
| **Constructors** | [New](#new) [NewDatabase](#newdatabase) [NewNATS](#newnats) [NewNull](#newnull) [NewQueueWithDefaults](#newqueuewithdefaults) [NewRabbitMQ](#newrabbitmq) [NewRedis](#newredis) [NewSQS](#newsqs) [NewStatsCollector](#newstatscollector) [NewSync](#newsync) [NewWorkerpool](#newworkerpool) |
...
| **Other** | [Dispatch](#dispatch) [Driver](#driver) [Register](#register) [Shutdown](#shutdown) [StartWorkers](#startworkers) |
...
| **Testing** | [AssertCount](#assertcount) [AssertDispatched](#assertdispatched) [AssertDispatchedOn](#assertdispatchedon) [AssertDispatchedTimes](#assertdispatchedtimes) [AssertNotDispatched](#assertnotdispatched) [AssertNothingDispatched](#assertnothingdispatched) [DispatchCtx](#dispatchctx) [NewFake](#newfake) [Records](#records) [Reset](#reset) [Workers](#workers) |
