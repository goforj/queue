...
| Group | Functions |
|------:|:-----------|
| **Constructors** | [bus.New](#bus-new) [bus.NewFake](#bus-newfake) [bus.NewJob](#bus-newjob) [bus.NewMemoryStore](#bus-newmemorystore) [bus.NewSQLStore](#bus-newsqlstore) [bus.NewWithStore](#bus-newwithstore) |
| **Events** | [bus.MultiObserver](#bus-multiobserver) [bus.Observe](#bus-observe) |
| **Job** | [bus.Backoff](#bus-backoff) [bus.Bind](#bus-bind) [bus.Delay](#bus-delay) [bus.OnQueue](#bus-onqueue) [bus.PayloadBytes](#bus-payloadbytes) [bus.Retry](#bus-retry) [bus.Timeout](#bus-timeout) [bus.UniqueFor](#bus-uniquefor) |
| **Middleware** | [bus.Handle](#bus-handle) |
| **Options** | [bus.WithClock](#bus-withclock) [bus.WithMiddleware](#bus-withmiddleware) [bus.WithObserver](#bus-withobserver) [bus.WithStore](#bus-withstore) |
| **Runtime** | [bus.FindBatch](#bus-findbatch) [bus.FindChain](#bus-findchain) [bus.Prune](#bus-prune) [bus.Register](#bus-register) [bus.Shutdown](#bus-shutdown) [bus.StartWorkers](#bus-startworkers) |
| **Testing** | [bus.AssertBatchCount](#bus-assertbatchcount) [bus.AssertBatched](#bus-assertbatched) [bus.AssertChained](#bus-assertchained) [bus.AssertCount](#bus-assertcount) [bus.AssertDispatched](#bus-assertdispatched) [bus.AssertDispatchedOn](#bus-assertdispatchedon) [bus.AssertDispatchedTimes](#bus-assertdispatchedtimes) [bus.AssertNotDispatched](#bus-assertnotdispatched) [bus.AssertNothingBatched](#bus-assertnothingbatched) [bus.AssertNothingDispatched](#bus-assertnothingdispatched) [bus.Batch](#bus-batch) [bus.Chain](#bus-chain) [bus.Dispatch](#bus-dispatch) |

### queue

| Group | Functions |
|------:|:-----------|
| **Constructors** | [queue.New](#queue-new) [queue.NewDatabase](#queue-newdatabase) [queue.NewNATS](#queue-newnats) [queue.NewNull](#queue-newnull) [queue.NewQueueWithDefaults](#queue-newqueuewithdefaults) [queue.NewRabbitMQ](#queue-newrabbitmq) [queue.NewRedis](#queue-newredis) [queue.NewSQS](#queue-newsqs) [queue.NewStatsCollector](#queue-newstatscollector) [queue.NewSync](#queue-newsync) [queue.NewWorkerpool](#queue-newworkerpool) |
| **Observability** | [queue.Active](#queue-active) [queue.Archived](#queue-archived) [queue.Failed](#queue-failed) [queue.MultiObserver](#queue-multiobserver) [queue.Observe](#queue-observe) [queue.PauseQueue](#queue-pausequeue) [queue.Paused](#queue-paused) [queue.Pending](#queue-pending) [queue.Processed](#queue-processed) [queue.Queue](#queue-queue) [queue.Queues](#queue-queues) [queue.ResumeQueue](#queue-resumequeue) [queue.RetryCount](#queue-retrycount) [queue.Scheduled](#queue-scheduled) [queue.Snapshot](#queue-snapshot) [queue.SnapshotQueue](#queue-snapshotqueue) [queue.SupportsNativeStats](#queue-supportsnativestats) [queue.SupportsPause](#queue-supportspause) [queue.Throughput](#queue-throughput) |
| **Queue** | [queue.Dispatch](#queue-dispatch) [queue.Driver](#queue-driver) [queue.Register](#queue-register) [queue.Shutdown](#queue-shutdown) [queue.StartWorkers](#queue-startworkers) |
| **Task** | [queue.Backoff](#queue-backoff) [queue.Bind](#queue-bind) [queue.Delay](#queue-delay) [queue.NewTask](#queue-newtask) [queue.OnQueue](#queue-onqueue) [queue.Payload](#queue-payload) [queue.PayloadBytes](#queue-payloadbytes) [queue.PayloadJSON](#queue-payloadjson) [queue.Retry](#queue-retry) [queue.Timeout](#queue-timeout) [queue.UniqueFor](#queue-uniquefor) |
| **Testing** | [queue.AssertCount](#queue-assertcount) [queue.AssertDispatched](#queue-assertdispatched) [queue.AssertDispatchedOn](#queue-assertdispatchedon) [queue.AssertDispatchedTimes](#queue-assertdispatchedtimes) [queue.AssertNotDispatched](#queue-assertnotdispatched) [queue.AssertNothingDispatched](#queue-assertnothingdispatched) [queue.DispatchCtx](#queue-dispatchctx) [queue.NewFake](#queue-newfake) [queue.Records](#queue-records) [queue.Reset](#queue-reset) [queue.Workers](#queue-workers) |
...
#### <a id="bus-observe"></a>bus.Observe
...
#### <a id="bus-backoff"></a>bus.Backoff
...
#### <a id="bus-onqueue"></a>bus.OnQueue
...
#### <a id="bus-payloadbytes"></a>bus.PayloadBytes
...
#### <a id="bus-timeout"></a>bus.Timeout
...
#### <a id="bus-uniquefor"></a>bus.UniqueFor
...
#### <a id="bus-handle"></a>bus.Handle

Handle calls the wrapped middleware function.

_Example: middleware func_
...
_Example: retry policy passthrough_

```go
policy := bus.RetryPolicy{}
```

_Example: skip by predicate_
...
_Example: rate limit middleware_
...
#### <a id="bus-findbatch"></a>bus.FindBatch
...
#### <a id="bus-findchain"></a>bus.FindChain
...
#### <a id="bus-register"></a>bus.Register
...
#### <a id="bus-shutdown"></a>bus.Shutdown
...
#### <a id="bus-startworkers"></a>bus.StartWorkers
...
#### <a id="bus-assertbatchcount"></a>bus.AssertBatchCount
...
#### <a id="bus-assertbatched"></a>bus.AssertBatched
...
#### <a id="bus-assertchained"></a>bus.AssertChained
...
#### <a id="bus-assertcount"></a>bus.AssertCount
...
#### <a id="bus-assertdispatched"></a>bus.AssertDispatched
...
#### <a id="bus-assertdispatchedon"></a>bus.AssertDispatchedOn
...
#### <a id="bus-assertdispatchedtimes"></a>bus.AssertDispatchedTimes
...
#### <a id="bus-assertnotdispatched"></a>bus.AssertNotDispatched
...
#### <a id="bus-assertnothingbatched"></a>bus.AssertNothingBatched
...
#### <a id="bus-assertnothingdispatched"></a>bus.AssertNothingDispatched
...
#### <a id="bus-batch"></a>bus.Batch

Batch records a batch specification.

_Example: record batch_
...
#### <a id="bus-chain"></a>bus.Chain

Chain records a chain specification.

_Example: record chain_
...
#### <a id="bus-dispatch"></a>bus.Dispatch

Dispatch records a dispatched job.

_Example: record dispatch_
...
#### <a id="queue-active"></a>queue.Active
...
#### <a id="queue-archived"></a>queue.Archived
...
#### <a id="queue-failed"></a>queue.Failed
...
#### <a id="queue-observe"></a>queue.Observe
...
#### <a id="queue-paused"></a>queue.Paused
...
#### <a id="queue-pending"></a>queue.Pending
...
#### <a id="queue-processed"></a>queue.Processed
...
#### <a id="queue-queue"></a>queue.Queue
...
#### <a id="queue-queues"></a>queue.Queues
...
#### <a id="queue-retrycount"></a>queue.RetryCount
...
#### <a id="queue-scheduled"></a>queue.Scheduled
...
#### <a id="queue-throughput"></a>queue.Throughput
...
#### <a id="queue-dispatch"></a>queue.Dispatch
...
#### <a id="queue-driver"></a>queue.Driver
...
#### <a id="queue-register"></a>queue.Register
...
#### <a id="queue-shutdown"></a>queue.Shutdown
...
#### <a id="queue-startworkers"></a>queue.StartWorkers
...
#### <a id="queue-backoff"></a>queue.Backoff
...
#### <a id="queue-delay"></a>queue.Delay
...
#### <a id="queue-onqueue"></a>queue.OnQueue
...
#### <a id="queue-payload"></a>queue.Payload
...
#### <a id="queue-payloadbytes"></a>queue.PayloadBytes
...
#### <a id="queue-payloadjson"></a>queue.PayloadJSON
...
#### <a id="queue-retry"></a>queue.Retry
...
#### <a id="queue-timeout"></a>queue.Timeout
...
#### <a id="queue-uniquefor"></a>queue.UniqueFor
...
#### <a id="queue-assertcount"></a>queue.AssertCount
...
#### <a id="queue-assertdispatched"></a>queue.AssertDispatched
...
#### <a id="queue-assertdispatchedon"></a>queue.AssertDispatchedOn
...
#### <a id="queue-assertdispatchedtimes"></a>queue.AssertDispatchedTimes
...
#### <a id="queue-assertnotdispatched"></a>queue.AssertNotDispatched
...
#### <a id="queue-assertnothingdispatched"></a>queue.AssertNothingDispatched
...
#### <a id="queue-dispatchctx"></a>queue.DispatchCtx
...
#### <a id="queue-records"></a>queue.Records
...
#### <a id="queue-reset"></a>queue.Reset
...
#### <a id="queue-workers"></a>queue.Workers
