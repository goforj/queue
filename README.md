...
<!-- test-count:embed:start -->
    <img src="https://img.shields.io/badge/unit_tests-542-brightgreen" alt="Unit tests (executed count)">
...
| **Constructors** | [New](#queue-new) · [NewMemoryStore](#queue-newmemorystore) · [NewMessage](#queue-newmessage) · [NewNull](#queue-newnull) · [NewSQLStore](#queue-newsqlstore) · [NewStatsCollector](#queue-newstatscollector) · [NewSync](#queue-newsync) · [NewWorkerpool](#queue-newworkerpool) |
