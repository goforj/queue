...
| Group | Functions |
|------:|:-----------|
| **Constructors** | [bus.New](#bus-new) [queue.New](#queue-new) [queue.NewDatabase](#queue-newdatabase) [bus.NewFake](#bus-newfake) [bus.NewJob](#bus-newjob) [queue.NewNATS](#queue-newnats) [queue.NewNull](#queue-newnull) [queue.NewQueueWithDefaults](#queue-newqueuewithdefaults) [queue.NewRabbitMQ](#queue-newrabbitmq) [queue.NewRedis](#queue-newredis) [queue.NewSQS](#queue-newsqs) [queue.NewStatsCollector](#queue-newstatscollector) [queue.NewSync](#queue-newsync) [bus.NewWithStore](#bus-newwithstore) [queue.NewWorkerpool](#queue-newworkerpool) |
| **Observability** | [queue.Active](#queue-active) [queue.Archived](#queue-archived) [queue.Failed](#queue-failed) [queue.MultiObserver](#queue-multiobserver) [queue.Observe](#queue-observe) [queue.PauseQueue](#queue-pausequeue) [queue.Paused](#queue-paused) [queue.Pending](#queue-pending) [queue.Processed](#queue-processed) [queue.Queue](#queue-queue) [queue.Queues](#queue-queues) [queue.ResumeQueue](#queue-resumequeue) [queue.Retry](#queue-retry) [queue.Scheduled](#queue-scheduled) [queue.Snapshot](#queue-snapshot) [queue.SnapshotQueue](#queue-snapshotqueue) [queue.SupportsNativeStats](#queue-supportsnativestats) [queue.SupportsPause](#queue-supportspause) [queue.Throughput](#queue-throughput) |
...
| **Task** | [queue.Backoff](#queue-backoff) [queue.Bind](#queue-bind) [queue.Delay](#queue-delay) [queue.NewTask](#queue-newtask) [queue.OnQueue](#queue-onqueue) [queue.Payload](#queue-payload) [queue.PayloadBytes](#queue-payloadbytes) [queue.PayloadJSON](#queue-payloadjson) [queue.Timeout](#queue-timeout) [queue.UniqueFor](#queue-uniquefor) |
